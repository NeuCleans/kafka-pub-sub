...
export declare class ServiceConsumerGroup {
    ...
    static init(defaultTopic?: string, defaultTopicOpts?: KafkaTopicConfig, consumerGroupOpts?: ConsumerGroupOptions, clientIdPrefix?: string, logger?: Logger, createHLProducer?: boolean): Promise<void>;
